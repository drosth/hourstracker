...
(function(global, factory) {
  ...
  function report(_ref) {
    ...
    if (noConflictsCount > 0) {
      console.info('%cNo conflict'.concat(noConflictsCount > 1 ? 's' : '', ' found with ')
        .concat(noConflictsCount == 1 ? 'this' : 'these', ':'), 'color: green; font-size: large')
      var _data = {}
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagScript.innerText = '('.concat(diagScriptFun.toString(), ')(\'')
        .concat(nodeUnderTestId, '\', \'').concat(testIconId || 'foo', '\', \'').concat(md5, '\', \'')
        .concat(parentOrigin, '\');')
  ...
  function detectSvgConflicts(currentScript) {
    ...
    var _loop = function _loop(scriptIdx) {
      ...
      diagScript.innerText = '('.concat(diagScriptFun.toString(), ')(\'')
        .concat(nodeUnderTestId, '\', \'').concat(md5ForScript, '\', \'').concat(parentOrigin, '\');')
