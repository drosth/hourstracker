...
// It is this service's responsibility of carrying out that layout.
  var core_layouts = {
    ...
    update: function(chart, width, height) {
      ...
      var outerBoxSizes = {
        top: topPadding, left: leftPadding, bottom: bottomPadding, right: rightPadding,
      }
      var minBoxSizes = []
      var maxPadding
    ...
    (function(global, factory) {
      ...
      function isSame(input, units) {
        ...
        if (units === 'millisecond') {
          ...
          return this.clone().startOf(units).valueOf() <= inputMs && inputMs <= this.clone()
            .endOf(units).valueOf()
        }
      }
      ...
      function getSetDayOfYear(input) {
        var dayOfYear = Math.round((this.clone().startOf('day') - this.clone()
